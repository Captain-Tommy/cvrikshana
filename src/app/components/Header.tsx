  ...
  return (
    <nav className={`fixed top-4 left-0 right-0 transition-all duration-300 ${scrolled ? 'bg-white/95 shadow-lg rounded-2xl mx-2' : 'bg-white/50'} backdrop-blur-lg border-b border-gray-200/50 z-50`}>
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center py-3 px-6 space-y-3 md:space-y-0">
        <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity rounded-full">
        ...
        <ul className="flex items-center gap-6">
          <li><Link href="/projects" className="text-[15px] text-gray-600 hover:text-gray-900 transition-colors duration-200">Our Projects</Link></li>
          <li><Link href="/about" className="text-[15px] text-gray-600 hover:text-gray-900 transition-colors duration-200">About Us</Link></li>
