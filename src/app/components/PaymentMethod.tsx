...
export default function PaymentMethod({ onClose, amount }: PaymentMethodProps) {
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-lg bg-black/20 flex items-center justify-center z-[100] p-4 pt-20 sm:pt-24 md:pt-28 lg:pt-32 animate-fadeIn overflow-y-auto">
      <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 max-w-4xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 relative animate-slideUp my-4">
        <div className="flex flex-col justify-center items-center md:border-r border-gray-200/50 md:pr-8 space-y-6">
          ...
          <div className="text-center w-full p-8 bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl shadow-inner">
            <p className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-600 mb-2">₹{amount}</p>
            <p className="text-gray-600 text-sm sm:text-base">Total Amount to Pay</p>
          </div>
        </div>
          ...
          {!paymentMethod && (
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center justify-center relative w-full">
                  <Image
                    ...
                    width={32}
                    height={32}
                    className="mr-3 transition-all duration-300 absolute left-4 group-hover:left-1/2 group-hover:-translate-x-1/2 group-hover:mr-0"
                  />
              ...
              <button
                ...
                className="w-full p-4 sm:p-5 border-2 rounded-2xl bg-gradient-to-r from-gray-800 to-gray-900 text-white hover:from-gray-900 hover:to-black border-transparent hover:border-gray-600 transition-all duration-300 font-medium relative group overflow-hidden shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                <div className="flex items-center justify-center relative w-full">
                  <Image
